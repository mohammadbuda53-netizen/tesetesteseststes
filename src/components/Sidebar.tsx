    ...
    <aside className="fixed left-0 top-0 h-screen w-64 bg-slate-900 text-white flex flex-col z-40">
      <div className="p-6 border-b border-slate-700">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-lg font-bold leading-tight">HandwerkerPro</h1>
      ...
      <div className="p-4 border-t border-slate-700">
        <div className="flex items-center gap-3 px-4 py-2">
          ...
          <div>
            <p className="text-sm font-medium">Admin Verwalter</p>
            <p className="text-xs text-slate-400">admin@handwerkerpro.de</p>
          </div>
        </div>
      </div>
    </aside>
